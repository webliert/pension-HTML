...
const items = [
  { name: '张女士', role: '家属 · 女儿', text: '把 85 岁的母亲送到颐康后，她每天都有活动参加，性格也比在家开朗了很多。护理员都很有耐心，让我们做儿女的能安心工作。' },
  { name: '李先生', role: '家属 · 儿子', text: '父亲中风后需要专业康复，颐康的康复师制定了详细计划，半年后已经能自己拄拐出门散步。专业的力量真的不一样。' },
  { name: '王阿姨', role: '家属 · 长女', text: '考察了三家最终选了颐康，花园环境最适合母亲。每月的家属沟通日院长亲自讲情况，这种透明让我们放心。' },
]
